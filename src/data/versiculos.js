...
export const versiculos = [
  { id: 1, tema: 'Amor', texto: 'O amor é paciente, o amor é bondoso. Não inveja, não se vangloria, não se orgulha.', referencia: '1 Coríntios 13:4' },
  { id: 2, tema: 'Família', texto: 'Porque eu e a minha casa serviremos ao Senhor.', referencia: 'Josué 24:15' },
  { id: 3, tema: 'Mãe', texto: 'Honra teu pai e tua mãe, para que se prolonguem os teus dias na terra.', referencia: 'Êxodo 20:12' },
